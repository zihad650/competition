        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Text('History of jessore',
                style: TextStyle(fontSize: 25),),
              Text('Jessore subdivision was established in 1854 under the district of Bakerganj. In 1873 it was separated from Bakerganj and annexed to Faridpur district. Madaripur subdivision was turned into a district in 1984. Madaripur district was named after Sufi saint Badruddin Shah Madar (15th century). He was one of the Sufi saints who came to Bangladesh from some Middle Eastern country in the 15th century to propagate Islam in Bengal. Shah Madar family. His son Ramesh Sen was head of the Madaripur Municipality later. Ramesh Sens son was a freedom fighter from Madarpur. His son-in-law Gangacharan Dasgupta led the National University movement.',
