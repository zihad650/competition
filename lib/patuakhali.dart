...
class potuakhali extends StatelessWidget {
  const potuakhali({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('History of Potuakhali'),
      ),
      body: Padding(
